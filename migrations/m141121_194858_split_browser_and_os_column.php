...
class m141121_194858_split_browser_and_os_column extends Migration
{
    public function safeUp()
    {
        ...
        $this->renameColumn(Yii::$app->getModule('user-management')->user_visit_log_table, 'browser_and_os',
            'user_agent');
    ...
    public function safeDown()
    {
        ...
        $this->renameColumn(Yii::$app->getModule('user-management')->user_visit_log_table, 'user_agent',
            'browser_and_os');
