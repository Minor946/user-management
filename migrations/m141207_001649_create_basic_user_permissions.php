...
use minor946\modules\UserManagement\models\rbacDB\Role;
...
class m141207_001649_create_basic_user_permissions extends Migration
{
    public function safeUp()
    {
        ...
        Role::assignRoutesViaPermission('Admin', 'createUsers', ['/user-management/user/create'], 'Create users',
            $group->code);
        ...
        Role::assignRoutesViaPermission('Admin', 'changeUserPassword', ['/user-management/user/change-password'],
            'Change user password', $group->code);
        ...
        Role::assignRoutesViaPermission('Admin', 'changeOwnPassword', ['/user-management/auth/change-own-password'],
            'Change own password', $group->code);
    }
