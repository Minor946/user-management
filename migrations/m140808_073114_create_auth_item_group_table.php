...
class m140808_073114_create_auth_item_group_table extends Migration
{
    public function safeUp()
    {
        ...
        if (\Yii::$app->db->schema->getTableSchema($table_name) === null) {
            ...
            $this->addForeignKey('fk_auth_item_group_code', Yii::$app->getModule('user-management')->auth_item_table,
                'group_code', Yii::$app->getModule('user-management')->auth_item_group_table, 'code', 'SET NULL',
                'CASCADE');
        }
