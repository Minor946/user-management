 ...
 * @var minor946\modules\UserManagement\models\User $model
 */
...
<div class="user-view">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <p>
                <?= GhostHtml::a(UserManagementModule::t('back', 'Edit'), ['update', 'id' => $model->id],
                    ['class' => 'btn btn-sm btn-primary']) ?>
                <?= GhostHtml::a(UserManagementModule::t('back', 'Create'), ['create'],
