...
<p>
    <?= GhostHtml::a(UserManagementModule::t('back', 'Edit'), ['update', 'id' => $role->name],
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php foreach ($allRoles as $aRole): ?>
                    <label>
                        <?php $isChecked = in_array($aRole['name'],
                            ArrayHelper::map($childRoles, 'name', 'name')) ? 'checked' : '' ?>
                                ...
                                <?php foreach ($permissions as $permission): ?>
                                    <label>
                                        <?php $isChecked = in_array($permission->name,
                                            ArrayHelper::map($currentPermissions, 'name', 'name')) ? 'checked' : '' ?>
