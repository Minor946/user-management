...
use minor946\modules\UserManagement\components\UserAuthEvent;
use minor946\modules\UserManagement\models\forms\ChangeOwnPasswordForm;
use minor946\modules\UserManagement\models\forms\ConfirmEmailForm;
use minor946\modules\UserManagement\models\forms\LoginForm;
            ...
            if ($this->triggerModuleEvent(UserAuthEvent::BEFORE_PASSWORD_RECOVERY_REQUEST, ['model' => $model])) {
                if ($model->sendEmail(false)) {
                    ...
                    Yii::$app->session->setFlash('error',
                        UserManagementModule::t('front', "Unable to send message for email provided"));
                }
            }
        }
