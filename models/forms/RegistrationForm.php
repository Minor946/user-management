...
namespace minor946\modules\UserManagement\models\forms;
...
class RegistrationForm extends Model
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [
                'username',
                'unique',
                'targetClass' => 'minor946\modules\UserManagement\models\User',
        ...
        if (Yii::$app->getModule('user-management')->useEmailAsLogin) {
            ...
            $rules[] = [
                ...
                'match',
                'not' => true,
                'pattern' => Yii::$app->getModule('user-management')->registrationBlackRegexp
            ];
        }
    ...
    {
        return [
            'username' => Yii::$app->getModule('user-management')->useEmailAsLogin ? 'E-mail' : UserManagementModule::t('front',
                'Login'),
