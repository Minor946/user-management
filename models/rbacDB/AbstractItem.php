...
namespace minor946\modules\UserManagement\models\rbacDB;

use minor946\modules\UserManagement\components\AbstractItemEvent;
    ...
    public static function removeChildren($parentName, $childrenNames)
    {
        ...
        foreach ($childrenNames as $childName) {
            Yii::$app->db->createCommand()
                ->delete(Yii::$app->getModule('user-management')->auth_item_child_table,
